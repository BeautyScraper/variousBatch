...
call FastCopy.bat C:\GalImgs\BabesImgs "C:\Heaven\Haven\brothel\%result.txt%"
...
call FastCopy.bat D:\paradise\stuff\BhartiyeNaari "C:\Heaven\Haven\brothel\%result.txt% BhartiyeNari"
...
call FastCopy.bat C:\GalImgs\Expande "C:\Heaven\Haven\brothel\%result.txt%"
